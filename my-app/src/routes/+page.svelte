<script>
    ...
    import NoahhLogo from "$lib/components/NoahhLogo.svelte";
...
<svelte:head>
    <title>Noahh - Mods for Geometry Dash</title>
    <meta name="description" content="Main page for Noahh, the most popular mod loader for Geometry Dash">
</svelte:head>
...
<Column align="center">
    <FlyIntoView reverseOnSmallScreen={true}>
        <Column>
            <p>
                Noahh is a <em>fan-made extension</em> for Geometry Dash that adds <em>mod support</em> to the game. 
    ...
    <FlyIntoView>
        ...
        <Column>
            <p>
                Noahh is the <em>most popular</em> GD mod loader across all platforms. With an <em>active community</em> of 
                both users and modders, nearly every mod you can imagine has been made or suggested!
            </p>
            <Row wrap="wrap">
                {#await new IndexClient()}
    ...
    <FlyIntoView reverseOnSmallScreen={true}>
        <Column>
            <p>
                Noahh is <em>open-source</em> and is designed to make the modding experience infinitely smoother for 
                developers. Noahh comes with a <em>special hooking syntax</em> as well as dozens of built-in 
                <em>UI components</em>, <em>utility functions</em>, and everything else needed to make mods.
            </p>
            <Row wrap="wrap">
                <Button href="https://docs.noahh-sdk.org/" style="secondary-filled">
                    <Icon icon="docs"/>Documentation
                </Button>
                <Button href="https://github.com/noahh-sdk/examples/">
    ...
    <FlyIntoView>
        <Column>
            <p>
                Interested? Go to the <em>Installation Page</em> to download Noahh for your device, or the 
                <em>Mods Browser</em> to view what mods Noahh has to offer!
            </p>
            <Row wrap="wrap">
