...
<svelte:head>
    <title>Browse Noahh Mods</title>
    <meta name="description" content="Browse mods for the Noahh mod loader">
</svelte:head>
					...
					{:else}
						<div class="no-mod-listing">
							...
							<p>
								...
								{:else}
									is not available on Noahh, or was made for an older version!
								{/if}
							</p>
						</div>
					{/if}
