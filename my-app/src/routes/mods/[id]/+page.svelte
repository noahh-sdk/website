				...
				<Column gap="small" align="stretch">
					<Column align="center">
						<InfoBox type="warning">
							...
							You will have to <em>manually install</em> the <code>.noahh</code> files you get from this page. 
							<br><br>
							...
							<article class="version">
								<Row wrap="wrap">
									<Column gap="small" align="left">
										...
										<span class="card-info"><Icon icon="noahh"/>
											Minimum Noahh version: <Label icon="noahh" style="gray">{version.noahh}</Label>
										</span>
									...
									<Column gap="small" align="stretch">
										<Button href={version.download_link} icon="download" style="primary-filled">Download .noahh file</Button>
	...
	<aside>
		<section>
			<Column align="left" gap="small">
				...
				<span class="card-info"><Icon icon="noahh"/>{data.version.noahh}</span>
				<span class="card-info"><Icon icon="gd"/>
