...
<FlyIntoView>
    <Image name="main-menu" alt="The main menu, showing the Noahh button" style="shadow"></Image>
    <Column align="left">
        <p>
...
<FlyIntoView>
    <Image name="main-page" alt="The Noahh menu" style="shadow"></Image>
    <Column align="left">
        <p>
...
<FlyIntoView>
    <Image name="download-page" alt="The download tab of the Noahh menu" style="shadow"></Image>
    <Column align="left">
        <p>
